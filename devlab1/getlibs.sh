...
wget https://repo1.maven.org/maven2/com/alibaba/fluss/fluss-fs-hadoop/0.6.0/fluss-fs-hadoop-0.6.0.jar
...
wget https://github.com/knaufk/flink-faker/releases/download/v0.5.3/flink-faker-0.5.3.jar
